...
return [
    ...
    'app_order_cancelled' => [[], ['_controller' => 'App\\Controller\\OrderController::cancelledOrders'], [], [['text', '/order/cancelled']], [], [], []],
    'order_get_state' => [['id'], ['_controller' => 'App\\Controller\\OrderController::getState'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/order/order/get-state']], [], [], []],
    'order_cancel' => [['id'], ['_controller' => 'App\\Controller\\OrderController::cancelOrder'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/order/cancel']], [], [], []],
    'app_order_new' => [[], ['_controller' => 'App\\Controller\\OrderController::new'], [], [['text', '/order/new']], [], [], []],
    'admin_order_toggle_payment' => [['id'], ['_controller' => 'App\\Controller\\OrderController::togglePayment'], [], [['text', '/toggle-payment'], ['variable', '/', '[^/]++', 'id', true], ['text', '/order/order']], [], [], []],
    'app_order_show' => [['id'], ['_controller' => 'App\\Controller\\OrderController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/order']], [], [], []],
    'app_order_assign_carrier' => [['id'], ['_controller' => 'App\\Controller\\OrderController::assignCarrier'], [], [['text', '/assign-carrier'], ['variable', '/', '[^/]++', 'id', true], ['text', '/order']], [], [], []],
    'app_order_set_delivery_date' => [['id'], ['_controller' => 'App\\Controller\\OrderController::setDeliveryDate'], [], [['text', '/set-delivery-date'], ['variable', '/', '[^/]++', 'id', true], ['text', '/order/admin/order']], [], [], []],
    'admin_order_update_payment_method' => [['id'], ['_controller' => 'App\\Controller\\OrderController::updatePaymentMethod'], [], [['text', '/update-payment-method'], ['variable', '/', '[^/]++', 'id', true], ['text', '/order/order']], [], [], []],
    ...
    'admin_order_generate_invoice' => [['id'], ['_controller' => 'App\\Controller\\OrderController::generateInvoice'], [], [['text', '/generate-invoice'], ['variable', '/', '[^/]++', 'id', true], ['text', '/order']], [], [], []],
    'admin_order_download_invoice' => [['id'], ['_controller' => 'App\\Controller\\OrderController::downloadInvoice'], [], [['text', '/download-invoice'], ['variable', '/', '[^/]++', 'id', true], ['text', '/order/admin/orders']], [], [], []],
    'admin_invoices' => [[], ['_controller' => 'App\\Controller\\OrderController::listInvoices'], [], [['text', '/order/admin/invoices']], [], [], []],
    'api_order_pdf' => [['id'], ['_controller' => 'App\\Controller\\OrderController::generatePdf'], [], [['text', '/pdf'], ['variable', '/', '[^/]++', 'id', true], ['text', '/order/api/order']], [], [], []],
    'app_product_index' => [[], ['_controller' => 'App\\Controller\\ProductController::index'], [], [['text', '/admin/product']], [], [], []],
    'app_product_list_api' => [[], ['_controller' => 'App\\Controller\\ProductController::productlist'], [], [['text', '/productlist']], [], [], []],
